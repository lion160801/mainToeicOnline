...
<c:url value="/admin-user-import-list.html" var="importUrl">
                                ...
                                <div class="table-btn-controls">
                                    <div class="pull-right tableTools-container">
                                        <div class="dt-buttons btn-overlap btn-group">
                                            ...
                                            <a flag="info"
                                               class="dt-button buttons-colvis btn btn-white btn-primary btn-bold" href="${importUrl}">
                                                <span>
                                ...
                                <display:table id="tableList" name="items.listResult" partialList="true"
                                    ...
                                    <display:column headerClass="col-actions" titleKey="label.action">
                                        ...
                                        <a class="btn btn-sm btn-danger btn-cancel" data-toggle="tooltip"
                                           title="<fmt:message key='label.user.delete' bundle='${lang}'/>">

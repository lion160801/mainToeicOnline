...
public class ExerciseQuestionController extends HttpServlet {
    ...
    private void getListenExerciseQuestion(ExerciseQuestionCommand command) {
        ...
        Object[] objects = SingletonServiceUtil.getExerciseQuestionServiceInstance().findExerciseQuestionByProperties
                (properties, command.getSortExpression(), command.getSortDirection(),command.getFirstItem(),command.getMaxPageItems());
